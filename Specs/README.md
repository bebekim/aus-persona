...
- [Spec 04: First PGM Feature Marts](04-first-pgm-feature-marts.md)
...
- [Spec 07: ABS G-Table Coverage Promotion](07-abs-g-table-coverage-promotion.md)

`02-pgm-feature-marts.md` predates the semantic-layer split and is retained as
historical backlog. Use `04-first-pgm-feature-marts.md` for first-tranche PGM
mart implementation.
