select
    ...
    d.physical_table,
    d.raw_column,
    'birthplace_summary'::text as feature_name,
    case
        when d.long_id like 'Birthplace_Australia_%' then 'Australia'
        when d.long_id like 'Birthplace_Elsewhere_%' then 'Elsewhere'
    end as birthplace_summary,
    d.sex,
    o.count,
    d.is_total,
    d.source_label,
...
where o.physical_table = 'sa2_g01'
    and {{ classify_g01_section('o.raw_column') }} = 'birthplace_summary_by_sex'
