with eligible_rows as (
    select
        ...
        sa2_name,
        state_name,
        'household_relationship'::text as feature_name,
        category::text as feature_value,
        age_band,
        sex,
        category::text as household_relationship,
        count,
    ...
    where logical_table_code = 'G27'
        and category_axis = 'household_relationship'
